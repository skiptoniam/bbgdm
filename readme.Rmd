...
##### Plot diagnostics
Using the \code{diagnostics} function we can extract Random Qunatile Residuals for plotting.
...
We can use \code{as.response} to look at the spline responses in our BBGDM.
